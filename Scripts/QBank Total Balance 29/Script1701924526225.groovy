...
WebUI.click(findTestObject('Object Repository/Page_/div_Fill Details'))

WebUI.click(findTestObject('Object Repository/Page_/div_Verify'))

WebUI.click(findTestObject('Object Repository/Page_/div_Confirmation'))
