...
WebUI.click(findTestObject('Object Repository/Page_/input_Phone_qbf-input medium ng-pristine ng_4fd4d5'))

WebUI.click(findTestObject('Object Repository/Page_/div_64BE1493F9B81691D3F9'))

WebUI.click(findTestObject('Object Repository/Page_/button_Update Information'))
