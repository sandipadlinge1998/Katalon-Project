...
WebUI.click(findTestObject('Object Repository/Page_/div_SERVICES        Account Statements     _23521e'))

WebUI.click(findTestObject('Object Repository/Page_/div_SERVICES'))
